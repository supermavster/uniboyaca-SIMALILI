...
if (isset($_POST) && !empty($_POST)) {
    // Data SQL
    $getData = self::getConnection()->db_exec("fetch_array", DocentDAO::getDocent($_POST[$idMain]))[0];
...
if (isset($_POST) && !empty($_POST)) {
    $data = '
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input type="hidden"  id="numberID" name="numberID" value="' . $getData['NumberDocument'] . '"/>
                    <input type="text" class="form-control" disabled value="' . $getData['NumberDocument'] . '">
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input class="form-control" id="jobTitle" name="jobTitle"  value="' . $getData['jobTitle'] . '" disabled
        ...
        <div class="container">
            <div class="card card-profile shadow mt--300">
                <div class="px-4">
                    ...
                    <span class="heading">Eliminar de:</span>
